...
import { TrendingUp, Mail, Lock, User, ArrowRight, Eye, EyeOff, Check } from "lucide-react";
    ...
    <div style={{
      ...
      <div style={{ width: "100%", maxWidth: 420, position: "relative", zIndex: 1 }}>
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          ...
          <p style={{ color: "var(--text-muted)", fontSize: 14 }}>Start making smarter investment decisions today</p>
        </div>

        <form onSubmit={handleSignup} className="card" style={{ padding: 32 }}>
          {error && (
            <div style={{
          ...
          <button type="submit" className="btn btn-primary" disabled={loading}
            ...
            {loading ? "Creating account..." : "Create Free Account"} {!loading && <ArrowRight size={16} />}
          </button>
